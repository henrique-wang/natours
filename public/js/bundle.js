...
exports.updateUserPassword = exports.updateUserData = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var updateUserData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          console.log("photo: ".concat(photo));
          _context.prev = 1;
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "User data updated successfully!");
...
var updateUserPassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(currentPassword, newPassword, newPasswordConfirm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "User password updated successfully!");
          }
          _context2.next = 10;
          break;
        case 7:
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _axios.default)("http://127.0.0.1:3001/api/v1/bookings/checkout-session/".concat(tourId));
        case 3:
          session = _context.sent;
          // 2) Redirect to session.data.redirectTo page (Checkout or Failed Page)
          window.setTimeout(function () {
            location.assign("".concat(session.data.redirectTo));
          }, 500);
          _context.next = 11;
          break;
        case 7:
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', function (e) {
    ...
    (0, _updateUserData.updateUserPassword)(currentPassword, newPassword, newPasswordConfirm);
